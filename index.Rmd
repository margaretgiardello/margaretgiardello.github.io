...
**Python, R, SQL, GitHub, Machine Learning | May 2026 – present**
...
## Prague Metro System
**SQL, Grafana, dbt | May 2026 – present, 3-person team**

Dimensional models built on synthetic transit data drawn from a variety of source
structures, representing metro system usage patterns to enable theoretical transit
design tailored to rider movement.
...
- Built a data pipeline from the Yelp Business API through Railway into Postgres,
